...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">生成Java实体</div>
		<div class="panel-body">
			<form id="form" action="/generation/exportJava" method="get">
				<div id="generatClassOne">
					...
					<div id="step3" style="display: none;">
						...
						<div class="form-group">
							<label for="entityPackage">包名<font color="red"><strong>(必填)</strong></font>：</label> 
							<input class="form-control" name="entityPackage" value="com.maven.web.entity" id="entityPackage" placeholder="请输入包名">
							<p class="help-block">	例：com.maven.web.entity</p>
						</div>
						<a class="btn btn-info" id="generatClass">生成</a> 
