 ...
 */
@WebServlet("/GenerationOfGetDBNamesServlet")
public class GenerationOfGetDBNamesServlet extends HttpServlet {
	 ...
	 */
	public GenerationOfGetDBNamesServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> list = generationMainService.getDbNameList(sqlFrom);
